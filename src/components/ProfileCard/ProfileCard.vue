...
const handleMiniAvatarError = (event) => {
  const target = event.target;
...
.pc-card-wrapper {
  ...
  --inner-gradient: none;
  --sunpillar-1: hsl(120, 100%, 73%);
  --sunpillar-2: hsl(120, 100%, 69%);
  --sunpillar-3: hsl(120, 100%, 69%);
  --sunpillar-4: hsl(120, 100%, 76%);
  --sunpillar-5: hsl(120, 100%, 74%);
  --sunpillar-6: hsl(120, 100%, 73%);
...
.pc-card {
  ...
  aspect-ratio: 0.718;
  border-radius: var(--card-radius);
  border: 1px solid rgba(132, 168, 146, 0.18);
  position: relative;
...
.pc-inside {
  ...
  background-color: rgba(10, 26, 10, 0.9);
